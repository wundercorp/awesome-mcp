...
| ThreadFox Lite | Read-only Reddit research for AI agents: subreddit rules with self-promotion rules flagged, community search, account standing and post status, read through the user's own signed-in Chrome. No API keys. | stdio | [Homepage](https://threadfox.vip)<br>[GitHub](https://github.com/amflimited/threadfox-lite)<br>[Package](https://pypi.org/project/threadfox-lite/) |
