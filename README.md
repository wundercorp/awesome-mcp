...
| OptionsAhoy | Equity-compensation planning math: ISO exercise schedules under AMT, NSO and RSU sell-vs-hold, lot selection, concentration risk, protective-put and collar pricing from daily option-chain data, and QSBS eligibility. No key, no signup. | streamable-http, stdio | [Homepage](https://optionsahoy.com/for-agents)<br>[GitHub](https://github.com/AlvisoOculus/optionsahoy-mcp)<br>[Package](https://www.npmjs.com/package/optionsahoy-mcp) |
...
| SearchLink Lite | Read-only Google Search Console reporting for MCP clients: site overview with period comparison, breakdowns by query, page, country, device or date, low-CTR and rank 8-20 opportunities, URL index inspection, sitemap status, on-page checks, and Google ranking update history. Runs locally over stdio with your own Google service-account credentials. | stdio | [Homepage](https://github.com/GlobalMatchHub/searchlink-lite)<br>[GitHub](https://github.com/GlobalMatchHub/searchlink-lite)<br>[Package](https://www.npmjs.com/package/searchlink-lite) |
