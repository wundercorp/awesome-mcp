...
| Robot Speed | Hosted SEO server for AI agents: 8-category site audits, Core Web Vitals, meta/schema/noindex checks, keyword ideas, AI visibility, Search Console traffic, backlinks and CMS publishing. 12 read-only tools work without an account; the rest use OAuth 2.1. | streamable-http | [Homepage](https://www.robot-speed.com/mcp)<br>[GitHub](https://github.com/robot-speed/mcp) |
