...
| Capital Flow Desk — UnlockFlow MCP | Unlock and capital-flow event tools for trading agents and bots, with schema-stable UnlockFlowEvent v1 and invalidation fields. Samples are illustrative and not financial advice (NFA); live feed onboarding is separate. | stdio | [Homepage](https://github.com/mhr2027r-dotcom/mcp-unlockflow)<br>[GitHub](https://github.com/mhr2027r-dotcom/mcp-unlockflow) |
