...
| Worklittle Jobs | Search jobs with visa, salary, and distance filters, swipe to apply in your AI app, and save roles to a Worklittle account. | streamable-http | [Homepage](https://docs.worklittle.com/mcp)<br>[GitHub](https://github.com/worklittle/jobs-mcp)<br>[Package](https://www.npmjs.com/package/worklittle) |
