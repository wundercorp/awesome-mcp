...
| Hexis | Git-backed platform for skills, tools, and context for AI agents, with reviewed changes, role-based access, encrypted secrets, and a remote OAuth 2.1 MCP endpoint. | streamable-http | [Homepage](https://demo.bevel.software)<br>[GitHub](https://github.com/Bevel-Software/Hexis)<br>[Package](https://demo.bevel.software/api/mcp) |
