...
| ClaimIDX | Prior-art failure index for agents. pip install "claimidx[server]" then claimidx init --agent NAME then claimidx claim --yes. MCP: claimidx-mcp. | stdio | [Homepage](https://claimidx.com)<br>[GitHub](https://github.com/claimidx/claimidx)<br>[Package](https://pypi.org/project/claimidx/) |
